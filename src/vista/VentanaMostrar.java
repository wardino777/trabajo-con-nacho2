...
public class VentanaMostrar extends javax.swing.JFrame {
    ...
    {
        DefaultTableModel dtm=(DefaultTableModel)jtVer.getModel();
        int n=jtVer.getRowCount()-1;
        for (int i = 0; i <=n; i++) 
        {
    ...
    private void initComponents() {
        ...
        if (jtVer.getColumnModel().getColumnCount() > 0) {
            jtVer.getColumnModel().getColumn(0).setResizable(false);
            jtVer.getColumnModel().getColumn(1).setResizable(false);
            jtVer.getColumnModel().getColumn(2).setResizable(false);
        }
